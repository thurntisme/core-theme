...
function core_theme_setup()
{
	 ...
	 * If you're building a theme based on core-theme, use a find and replace
	 * to change 'core-theme' to the name of your theme in all the template files.
	 */
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__('Primary', 'core-theme'),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'core_theme_custom_background_args',
			array(
 ...
 */
function core_theme_content_width()
{
	$GLOBALS['content_width'] = apply_filters('core_theme_content_width', 640);
}
...
function core_theme_widgets_init()
{
	register_sidebar(
		array(
			'name' => esc_html__('Sidebar', 'core-theme'),
			'id' => 'sidebar-1',
			'description' => esc_html__('Add widgets here.', 'core-theme'),
